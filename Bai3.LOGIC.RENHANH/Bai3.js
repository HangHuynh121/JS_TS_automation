...
/*switch case..(thuong sẽ sử dụng để kiểm tra biến duy nhất với nhiều giá trị khảthi)
switch (bien cần kiểm tra)
    case giaiTri1:
        code thuc thi
        break;
    case giaTri2:
...
switch (env) {
    ...
    case 'stg':
        ...
        break;
    default:
        console.log('Loi khong tim thay moi truong');

}

console.log(`Cấu hình được thiết lập cới URL: ${baseUrl}, ${useName}, ${passWord}`)
